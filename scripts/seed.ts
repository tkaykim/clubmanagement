...
async function insertSeedData(): Promise<void> {
  ...
  const { error: projError } = await supabase.from("projects").upsert([
    { id: "a1b2c3d4-0001-0000-0000-000000000001", owner_id: "d0000000-0001-0000-0000-000000000001", title: "원샷크루 5월 정기공연 〈FRAME〉", description: "원샷크루가 올해 처음 선보이는 정기공연.", status: "recruiting", type: "paid_gig", venue: "서울 성수 S팩토리 B홀", address: "서울 성동구 성수이로 123", fee: 350000, max_participants: 12, recruitment_end_at: "2026-04-28T23:59:59Z" },
    { id: "a1b2c3d4-0002-0000-0000-000000000002", owner_id: "d0000000-0001-0000-0000-000000000001", title: "브랜드 X 런칭 파티 퍼포먼스", description: "브랜드 런칭 이벤트 오프닝 퍼포먼스.", status: "in_progress", type: "paid_gig", venue: "강남 L호텔 그랜드볼룸", address: "서울 강남구 테헤란로 450", fee: 500000, max_participants: 6, recruitment_end_at: "2026-04-14T23:59:59Z" },
    { id: "a1b2c3d4-0003-0000-0000-000000000003", owner_id: "d0000000-0001-0000-0000-000000000001", title: "4월 팀 정기연습", description: "주간 팀 연습.", status: "in_progress", type: "practice", venue: "연남동 큐브 연습실 2호", address: "서울 마포구 연남로 30", fee: -20000, max_participants: null, recruitment_end_at: "2026-04-22T23:59:59Z" },
    { id: "a1b2c3d4-0004-0000-0000-000000000004", owner_id: "d0000000-0001-0000-0000-000000000001", title: "유니버시티 페스티벌 오픈콜", description: "대학 축제 투어.", status: "recruiting", type: "audition", venue: "경기 일산 킨텍스 제2전시장", address: "경기 고양시 일산서구 킨텍스로 217", fee: 200000, max_participants: 8, recruitment_end_at: "2026-05-10T23:59:59Z" },
  ], { onConflict: "id" });
